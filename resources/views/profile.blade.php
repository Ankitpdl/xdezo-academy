					...
					<div class="box position-sticky t-100">
						<div class="box-body text-center">
							<div class="mb-20 mt-20">
								<img src="{{asset('assets/images/front-end-img/avatar/9.jpg')}}" width="150" class="rounded-circle bg-info-light" alt="user">
							    ...
							    <div class="tab-pane fade show active" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-tab">
									...
									<div class="popup-gallery">
										<div class="d-flex gap-items-2 mb-10">
											<a href="{{asset('assets/images/front-end-img/courses/1.jpg')}}" title="Caption. Can be aligned to any side and contain any HTML.">
												<img src="{{asset('assets/images/front-end-img/courses/1.jpg')}}" alt="" />
											</a>
											<a href="{{asset('assets/images/front-end-img/courses/2.jpg')}}" title="This image fits only horizontally.">
												<img src="{{asset('assets/images/front-end-img/courses/2.jpg')}}" alt="" />
											</a>
											<a href="{{asset('assets/images/front-end-img/courses/3.jpg')}}" title="Caption. Can be aligned to any side and contain any HTML.">
												<img src="{{asset('assets/images/front-end-img/courses/3.jpg')}}" alt="" />
											</a>										
										</div>
										<div class="d-flex gap-items-2">
											<a href="{{asset('assets/images/front-end-img/courses/4.jpg')}}" title="Caption. Can be aligned to any side and contain any HTML.">
												<img src="{{asset('assets/images/front-end-img/courses/4.jpg')}}" alt="" />
											</a>
											<a href="{{asset('assets/images/front-end-img/courses/5.jpg')}}" title="Caption. Can be aligned to any side and contain any HTML.">
												<img src="{{asset('assets/images/front-end-img/courses/5.jpg')}}" alt="" />
											</a>
											<a href="{{asset('assets/images/front-end-img/courses/6.jpg')}}" title="Caption. Can be aligned to any side and contain any HTML.">
												<img src="{{asset('assets/images/front-end-img/courses/6.jpg')}}" alt="" />
											</a>										
										</div>
									</div>
								</div>
							    <div class="tab-pane fade" id="pills-courses" role="tabpanel" aria-labelledby="pills-courses-tab">
									<div class="row">
										...
										<div class="col-lg-4 col-12">
											<div class="card">
											  <img class="card-img-top" src="{{asset('assets/images/front-end-img/courses/1.jpg')}}" alt="Card image cap">
											  <div class="card-body">
							    ...
							    <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab">
									<div class="row">
										...
										<div class="col-md-6 col-12">											
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-3.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-4.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-25">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-5.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-6.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-7.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-8.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-9.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
											...
											<div class="d-flex align-items-center mb-25">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-10.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
										...
										<div class="col-md-6 col-12">											
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-11.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
													<a href="#" class="text-dark hover-primary mb-1 fs-16">Sophia</a>
													<span class="text-mute">sophia@dummy.com</span>
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-12.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
													<a href="#" class="text-dark hover-danger mb-1 fs-16">Mason</a>
													<span class="text-mute">mason@dummy.com</span>
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-13.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
													<a href="#" class="text-dark hover-success mb-1 fs-16">Emily</a>
													<span class="text-mute">emily@dummy.com</span>
											...
											<div class="d-flex align-items-center mb-25">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-15.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
													<a href="#" class="text-dark hover-warning mb-1 fs-16">Natalie</a>
													<span class="text-mute">natalie@dummy.com</span>
											...
											<div class="d-flex align-items-center mb-30">
												<div class="me-15">
													<img src="{{asset('assets/images/avatar/avatar-16.png" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
												</div>
												<div class="d-flex flex-column fw-500">
													<a href="#" class="text-dark hover-primary mb-1 fs-16">Clark</a>
													<span class="text-mute">clark@dummy.com</span>
