		...
		<div class="container">
			<div class="row">
							...
							<div class="staff-bx">
								<div class="staff-info d-flex align-items-center">
									<div class="staff-thumb me-10">
										<img src="{{asset('assets/images/avatar/avatar-1.png')}}" alt="" class="bg-secondary-light rounded-circle max-w-60">
									</div>
								...
								<div class="owl-carousel" data-nav-dots="false" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
										...
										<div class="testimonial-widget">
											...
											<div class="testimonial-info mt-20">
												<div class="testimonial-avtar">
													<img class="img-fluid" src="{{asset('assets/images/avatar/1.jpg')}}" alt="">
												</div>
									...
									<div class="item">
										<div class="testimonial-widget">
											...
											<div class="testimonial-info mt-20">
												<div class="testimonial-avtar">
													<img class="img-fluid" src="{{asset('assets/images/avatar/2.jpg')}}" alt="">
												</div>
												<div class="testimonial-name">
													<strong>Johen Doe</strong>
													<span>Design</span>
									...
									<div class="item">
										<div class="testimonial-widget">
											...
											<div class="testimonial-info mt-20">
												<div class="testimonial-avtar">
													<img class="img-fluid" src="{{asset('assets/images/avatar/3.jpg')}}" alt="">
												</div>
												<div class="testimonial-name">
													<strong>Johen Doe</strong>
													<span>Project Manager</span>
									...
									<div class="item">
										<div class="testimonial-widget">
											...
											<div class="testimonial-info mt-20">
												<div class="testimonial-avtar">
													<img class="img-fluid" src="{{asset('assets/images/avatar/4.jpg')}}" alt="">
												</div>
												<div class="testimonial-name">
													<strong>Johen Doe</strong>
													<span>Design</span>
				...
				<div class="col-xl-8 col-md-7 col-12">
					<div class="box">
					  <img class="box-img-top btrr-5 btlr-5" src="{{asset('assets/images/front-end-img/courses/4f.jpg')}}" alt="Card image cap">
					  <div class="box-body">
					...
					<div class="box">
					  <div class="box-body">
						  <div class="staff-bx">
							  <div class="d-flex align-items-center">
								  <div class="staff-pic">
									  <img src="{{asset('assets/images/front-end-img/avatar/1.jpg')}}" class="bg-primary-light rounded w-50" alt="" >
								  </div>
					...
					<div class="box">
					  <div class="box-body">
						  <div class="staff-bx">
							  <div class="d-flex align-items-center">
								  <div class="staff-pic">
									  <img src="{{asset('assets/images/front-end-img/avatar/2.jpg')}}" class="bg-primary-light rounded w-50" alt="" >
								  </div>
								  <div class="staff-dis ms-15">
